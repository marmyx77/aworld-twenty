...
> = {
  [K in keyof Omit<
    AtomicFlatEntity<MetadataEntity<TMetadataName>> &
      CastRecordTypeOrmDatePropertiesToString<MetadataEntity<TMetadataName>>,
...
export type MetadataEntityAtomicPropertyName<T extends AllMetadataName> =
  Exclude<
    MetadataEntityPropertyName<T>,
    keyof CastRecordTypeOrmDatePropertiesToString<MetadataEntity<T>>
  >;
